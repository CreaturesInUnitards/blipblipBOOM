...
module.exports = [
	{
		...
		flems: [
			{ notes: TEXT, label: '"Hello world" in HTML :)', url: 'y8hnv3x5' },
			{ notes: TEXT, label: '"Hello world" in vanilla JS', url: 'ya5j5772' },
			{ notes: TEXT, label: '"Hello world" in... CSS?', url: 'y7pymq33' }
		]
	},
	{
		label: 'Hello, World!',
	...
	{
		label: 'Hyperscript, Components, and Shared State',
		id: 256259017,
		links: [
			{ text: 'hyperscript API reference', url: 'https://mithril.js.org/hyperscript.html' }
		],
